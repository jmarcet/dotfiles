...
alias cd..="cd .."
alias _chgrp="${_coredir}/chgrp"
alias chgrp="${_coredir}/chgrp -v"
alias _chown="${_coredir}/chown"
alias chown="${_coredir}/chown -v"
alias _cp="${_coredir}/${_g}cp -f"
alias cp="${_coredir}/${_g}cp -i --verbose"
alias date-now="date +%Y.%m.%d-%H.%M"
alias diff="diff -X ~/.rsync-filter"
alias d="${_coredir}/${_g}ls --color"
...
alias la="${_coredir}/${_g}ls -I 'lost+found' --color=auto -Ahlp"
alias ll="${_coredir}/${_g}ls -I 'lost+found' --color -l"
...
alias ls="${_coredir}/${_g}ls -I 'lost+found' --color=auto"
alias lz="${_coredir}/${_g}ls -I 'lost+found' --color=auto -AZhlp"
alias manb="man -H"
alias mpv-vita="mpv --demuxer-lavf-format video4linux2 av://v4l2:/dev/video2 -fs"
alias _mv="${_coredir}/${_g}mv -f"
alias mv="${_coredir}/${_g}mv -iv --verbose"
...
alias _rm="${_coredir}/${_g}rm"
alias rm="${_coredir}/${_g}rm -iv"
